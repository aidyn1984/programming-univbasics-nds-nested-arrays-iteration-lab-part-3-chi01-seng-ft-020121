...
while row_index < array_of_daily_temperatures.count do
  ...
  while element_index < array_of_daily_temperatures[row_index].count do
    ...
    if array_of_daily_temperatures[row_index][element_index].length > longest_string_element.length
      longest_string_element = array_of_daily_temperatures[row_index][element_index]
    end
    element_index += 1
  end
